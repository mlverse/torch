...
use
[`torch::cuda_memory_summary()`](https://torch.mlverse.org/docs/reference/cuda_memory_stats.md)
...
[pytorch.org/memory_viz](https://torch.mlverse.org/docs/articles/pytorch.org/memory_viz).
