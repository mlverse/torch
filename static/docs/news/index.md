...
- Fixed
  [`dataset()`](https://torch.mlverse.org/docs/reference/dataset.md)/[`nn_module()`](https://torch.mlverse.org/docs/reference/nn_module.md)
...
- [`nnf_gelu()`](https://torch.mlverse.org/docs/reference/nnf_gelu.md)
  and [`nn_gelu()`](https://torch.mlverse.org/docs/reference/nn_gelu.md)
...
- Added
  [`nn_silu()`](https://torch.mlverse.org/docs/reference/nn_silu.md) and
...
- [`sampler()`](https://torch.mlverse.org/docs/reference/sampler.md) is
  now exported allowing to create custom samplers that can be passed to
...
- Adds `cuda_get_device_properties(device)` that allows one to query
  ...
  [@rdinnager](https://github.com/rdinnager))
- Implemented
  [`call_torch_function()`](https://torch.mlverse.org/docs/reference/call_torch_function.md)
...
- Added
  ...
  and
  [`get_install_libs_url()`](https://torch.mlverse.org/docs/reference/install_torch_from_file.md)for
...
- Internal refactoring making Rcpp aware of some XPtrTorch\* types so
  ...
  [`torch_dtype()`](https://torch.mlverse.org/docs/reference/torch_dtype.md)
  being an R6 class.
