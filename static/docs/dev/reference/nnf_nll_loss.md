...
- input:
  ...
  \\(N, C)\\ where `C = number of classes` or \\(N, C, H, W)\\ in case
  of 2D Loss, or \\(N, C, d_1, d_2, ..., d_K)\\ where \\K \geq 1\\ in
  the case of K-dimensional loss.

- target:

  \\(N)\\ where each value is \\1 \leq \mbox{targets}\[i\] \leq C\\, or
  \\(N, d_1, d_2, ..., d_K)\\ where \\K \geq 1\\ for K-dimensional loss.
