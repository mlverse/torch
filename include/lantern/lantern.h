...
LANTERN_API void (LANTERN_PTR lantern_normal_tensor_double_generator)(void* mean, void* std, void* generator);
...
LANTERN_API void (LANTERN_PTR lantern_normal_double_tensor_generator)(void* mean, void* std, void* generator);
...
LANTERN_API void (LANTERN_PTR lantern_normal_tensor_tensor_generator)(void* mean, void* std, void* generator);
...
bool lanternInit(const std::string& libPath, std::string* pError)
{
  ...
  LOAD_SYMBOL(lantern_normal_tensor_double_generator)
  LOAD_SYMBOL(lantern_normal_out_tensor_double_tensor_generator)
  LOAD_SYMBOL(lantern_normal_double_tensor_generator)
  LOAD_SYMBOL(lantern_normal_out_tensor_tensor_tensor_generator)
  LOAD_SYMBOL(lantern_normal_tensor_tensor_generator)
