...
test_that("cpp_jit_execute() works") {
  #   what():  isInt() INTERNAL ASSERT FAILED at "../aten/src/ATen/core/ivalue.h":602, please report a bug to PyTorch.
  # res <- cpp_jit_execute("aten::sum", list(torch::torch_eye(5)))
