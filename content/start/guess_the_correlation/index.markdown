...
As you can see, the network has made good progress -- on both training and validation set. How about the test set? Again, before running the respective code we want to make sure we're in evaluation mode.
...
Pretty similar to validation-set performance.
