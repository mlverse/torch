...
public:
  XPtrTorchOptionalTensorList (void* x) : XPtrTorch(x, delete_optional_tensor_list) {}
...
public:
  XPtrTorchOptionalIndexTensorList (void* x) : XPtrTorch(x, delete_optional_tensor_list) {}
...
public:
  XPtrTorchjit_named_buffer_list (void* x) : XPtrTorch(x, delete_jit_named_buffer_list) {}
...
public:
  XPtrTorchjit_named_module_list (void* x) : XPtrTorch(x, delete_jit_named_module_list) {}
...
public:
  ...
  XPtrTorchstring (std::string x) : XPtrTorchstring(fixme_new_string(x.c_str())) {};
  operator SEXP () const;
};
...
public:
  XPtrTorchNamedTupleHelper (void* x) : XPtrTorch(x, delete_named_tuple_helper) {}
...
public:
  XPtrTorchTraceableFunction (void * x) : XPtrTorch(x, delete_traceable_function) {}
};
