...
void delete_function_schema(void* x);
void delete_function_schema_list(void* x);
void delete_function_schema_argument(void* x);
void delete_function_schema_argument_list(void* x);
