...
indices for indexing from the end of the array (In R, negative indexes are used to remove elements).
...
Like in R, you can skip indexing dimension by leaving an empty index for that dimension.
...
It's possible to add a new dimension to a tensor using an index like syntax:
