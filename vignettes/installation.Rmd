...
-   Have properly installed the NVIDIA CUDA toolkit version 10.2. For CUDA v10.2, follow the installation instructions [here](https://docs.nvidia.com/cuda/archive/10.2/cuda-installation-guide-microsoft-windows/index.html). **Note**: We currently do **not** support the latest CUDA version 11.
