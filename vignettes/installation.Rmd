...
-   Have properly installed the NVIDIA CUDA toolkit version 10.2 or 11.1. For CUDA v11.1, follow the installation instructions [here](https://docs.nvidia.com/cuda/archive/11.1.1/index.html). **Note**: We currently do **not** support the latest CUDA version 11.

-   Have installed cuDNN version 7.6 (if using CUDA v10.2) or cuDNN 8.0 (if using CUDA 11.1). 
Follow the installation instructions available [here](https://docs.nvidia.com/deeplearning/cudnn/archives/cudnn-805/install-guide/index.html).
...
-   You have correctly installed the NVIDIA CUDA Toolkit versions 10.2 or 11.1, follow the instructions [here](https://docs.nvidia.com/cuda/archive/11.1.1/index.html).

-   You have installed cuDNN version 7.6 - (for CUDA 10.2) and 8.0 for CUDA 11.1. Follow the installation instructions available [here](https://docs.nvidia.com/deeplearning/cudnn/archives/cudnn-805/install-guide/index.html). 
