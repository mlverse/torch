...
-   Have properly installed the NVIDIA CUDA toolkit version 11.7. For CUDA v11.7, follow the installation instructions [here](https://developer.nvidia.com/cuda-11-7-0-download-archive). **Note**: The version of the CUDA toolkit must match exactly what's mentioed above.

-   Have installed cuDNN - a version compatible with CUDA v11.7. Follow the installation instructions available [here](https://developer.nvidia.com/cudnn).
