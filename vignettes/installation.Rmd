...
-   You have correctly installed the NVIDIA CUDA Toolkit versions 10.1, 10.2 or 11.0, follow the instructions [here](https://docs.nvidia.com/cuda/archive/11.0/cuda-installation-guide-linux/index.html).

-   You have installed cuDNN version 7.6 - (for CUDA 10.1 or 10.2) and 8.0 for CUDA 11.0. Follow the installation instructions available [here](https://docs.nvidia.com/deeplearning/cudnn/archives/cudnn-805/install-guide/index.html). 
