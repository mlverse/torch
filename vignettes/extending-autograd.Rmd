...
-   (Not implemented) `mark_dirty()` must be used to mark any input that is modified inplace by the forward function.

-   (Not implemented) `mark_non_differentiable()` must be used to tell the engine if an output is not differentiable.
