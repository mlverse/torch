...
#> frame #0: c10::Error::Error(c10::SourceLocation, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>) + 52 (0x10407855c in libc10.dylib)
#> frame #1: c10::detail::torchCheckFail(char const*, char const*, unsigned int, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> const&) + 140 (0x1040751ac in libc10.dylib)
#> frame #2: torch::jit::tracer::addInput(std::__1::shared_ptr<torch::jit::tracer::TracingState> const&, c10::IValue const&, c10::Type::SingletonOrSharedTypePtr<c10::Type> const&, torch::jit::Value*) + 5648 (0x1199fbda4 in libtorch_cpu.dylib)
#> frame #3: torch::jit::tracer::addInput(std::__1::shared_ptr<torch::jit::tracer::TracingState> const&, c10::IValue const&, c10::Type::SingletonOrSharedTypePtr<c10::Type> const&, torch::jit::Value*) + 4268 (0x1199fb840 in libtorch_cpu.dylib)
#> frame #4: torch::jit::tracer::trace(std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>>, std::__1::function<std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>> (std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>>)> const&, std::__1::function<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> (at::Tensor const&)>, bool, bool, torch::jit::Module*, std::__1::vector<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::allocator<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>> const&) + 680 (0x1199f926c in libtorch_cpu.dylib)
#> frame #5: _lantern_trace_fn + 292 (0x109169dd4 in liblantern.dylib)
#> frame #6: cpp_trace_function(Rcpp::Function_Impl<Rcpp::PreserveStorage>, XPtrTorchStack, XPtrTorchCompilationUnit, XPtrTorchstring, bool, XPtrTorchScriptModule, bool, bool) + 524 (0x1072cb78c in torchpkg.so)
#> frame #7: _torch_cpp_trace_function + 688 (0x1070bd3f0 in torchpkg.so)
#> frame #8: R_doDotCall + 3356 (0x1016c40dc in libR.dylib)
#> frame #9: bcEval_loop + 81268 (0x101713bf4 in libR.dylib)
#> frame #10: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #11: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #12: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #13: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #14: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #15: do_eval + 1352 (0x1016f8ec8 in libR.dylib)
#> frame #16: bcEval_loop + 27244 (0x1017068ec in libR.dylib)
#> frame #17: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #18: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #19: forcePromise + 232 (0x1016f2668 in libR.dylib)
#> frame #20: Rf_eval + 660 (0x1016f1bd4 in libR.dylib)
#> frame #21: do_withVisible + 64 (0x1016f9200 in libR.dylib)
#> frame #22: do_internal + 400 (0x101758490 in libR.dylib)
#> frame #23: bcEval_loop + 27828 (0x101706b34 in libR.dylib)
#> frame #24: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #25: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #26: forcePromise + 232 (0x1016f2668 in libR.dylib)
#> frame #27: Rf_eval + 660 (0x1016f1bd4 in libR.dylib)
#> frame #28: forcePromise + 232 (0x1016f2668 in libR.dylib)
#> frame #29: getvar + 408 (0x101715a18 in libR.dylib)
#> frame #30: bcEval_loop + 16936 (0x1017040a8 in libR.dylib)
#> frame #31: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #32: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #33: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #34: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #35: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #36: do_eval + 1352 (0x1016f8ec8 in libR.dylib)
#> frame #37: bcEval_loop + 27244 (0x1017068ec in libR.dylib)
#> frame #38: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #39: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #40: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #41: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #42: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #43: do_begin + 400 (0x1016f6fd0 in libR.dylib)
#> frame #44: Rf_eval + 1012 (0x1016f1d34 in libR.dylib)
#> frame #45: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #46: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #47: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #48: do_docall + 628 (0x1016903b4 in libR.dylib)
#> frame #49: bcEval_loop + 27244 (0x1017068ec in libR.dylib)
#> frame #50: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #51: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #52: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #53: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #54: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #55: do_docall + 628 (0x1016903b4 in libR.dylib)
#> frame #56: bcEval_loop + 27244 (0x1017068ec in libR.dylib)
#> frame #57: bcEval + 592 (0x1016f23d0 in libR.dylib)
#> frame #58: Rf_eval + 556 (0x1016f1b6c in libR.dylib)
#> frame #59: R_execClosure + 816 (0x1016f4730 in libR.dylib)
#> frame #60: applyClosure_core + 164 (0x1016f3824 in libR.dylib)
#> frame #61: Rf_eval + 1224 (0x1016f1e08 in libR.dylib)
#> frame #62: forcePromise + 232 (0x1016f2668 in libR.dylib)
#> :
```
