...
#> frame #0: c10::Error::Error(c10::SourceLocation, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>) + 56 (0x104292b74 in libc10.dylib)
#> frame #1: c10::detail::torchCheckFail(char const*, char const*, unsigned int, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> const&) + 120 (0x1042900e8 in libc10.dylib)
#> frame #2: torch::jit::tracer::addInput(std::__1::shared_ptr<torch::jit::tracer::TracingState> const&, c10::IValue const&, c10::Type::SingletonOrSharedTypePtr<c10::Type> const&, torch::jit::Value*) + 5780 (0x119370978 in libtorch_cpu.dylib)
#> frame #3: torch::jit::tracer::addInput(std::__1::shared_ptr<torch::jit::tracer::TracingState> const&, c10::IValue const&, c10::Type::SingletonOrSharedTypePtr<c10::Type> const&, torch::jit::Value*) + 4288 (0x1193703a4 in libtorch_cpu.dylib)
#> frame #4: torch::jit::tracer::trace(std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>>, std::__1::function<std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>> (std::__1::vector<c10::IValue, std::__1::allocator<c10::IValue>>)> const&, std::__1::function<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> (at::Tensor const&)>, bool, bool, torch::jit::Module*, std::__1::vector<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::allocator<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>> const&) + 660 (0x11936e158 in libtorch_cpu.dylib)
#> frame #5: _lantern_trace_fn + 252 (0x108654a88 in liblantern.dylib)
#> frame #6: cpp_trace_function(Rcpp::Function_Impl<Rcpp::PreserveStorage>, XPtrTorchStack, XPtrTorchCompilationUnit, XPtrTorchstring, bool, XPtrTorchScriptModule, bool, bool) + 528 (0x106914490 in torchpkg.so)
#> frame #7: _torch_cpp_trace_function + 688 (0x106705f30 in torchpkg.so)
#> frame #8: R_doDotCall + 3356 (0x10130811c in libR.dylib)
#> frame #9: bcEval_loop + 81268 (0x101357c34 in libR.dylib)
#> frame #10: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #11: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #12: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #13: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #14: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #15: do_eval + 1352 (0x10133cf08 in libR.dylib)
#> frame #16: bcEval_loop + 27244 (0x10134a92c in libR.dylib)
#> frame #17: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #18: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #19: forcePromise + 232 (0x1013366a8 in libR.dylib)
#> frame #20: Rf_eval + 660 (0x101335c14 in libR.dylib)
#> frame #21: do_withVisible + 64 (0x10133d240 in libR.dylib)
#> frame #22: do_internal + 400 (0x10139c4d0 in libR.dylib)
#> frame #23: bcEval_loop + 27828 (0x10134ab74 in libR.dylib)
#> frame #24: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #25: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #26: forcePromise + 232 (0x1013366a8 in libR.dylib)
#> frame #27: Rf_eval + 660 (0x101335c14 in libR.dylib)
#> frame #28: forcePromise + 232 (0x1013366a8 in libR.dylib)
#> frame #29: getvar + 408 (0x101359a58 in libR.dylib)
#> frame #30: bcEval_loop + 16936 (0x1013480e8 in libR.dylib)
#> frame #31: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #32: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #33: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #34: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #35: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #36: do_eval + 1352 (0x10133cf08 in libR.dylib)
#> frame #37: bcEval_loop + 27244 (0x10134a92c in libR.dylib)
#> frame #38: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #39: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #40: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #41: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #42: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #43: do_begin + 400 (0x10133b010 in libR.dylib)
#> frame #44: Rf_eval + 1012 (0x101335d74 in libR.dylib)
#> frame #45: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #46: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #47: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #48: do_docall + 628 (0x1012d43f4 in libR.dylib)
#> frame #49: bcEval_loop + 27244 (0x10134a92c in libR.dylib)
#> frame #50: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #51: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #52: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #53: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #54: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #55: do_docall + 628 (0x1012d43f4 in libR.dylib)
#> frame #56: bcEval_loop + 27244 (0x10134a92c in libR.dylib)
#> frame #57: bcEval + 592 (0x101336410 in libR.dylib)
#> frame #58: Rf_eval + 556 (0x101335bac in libR.dylib)
#> frame #59: R_execClosure + 816 (0x101338770 in libR.dylib)
#> frame #60: applyClosure_core + 164 (0x101337864 in libR.dylib)
#> frame #61: Rf_eval + 1224 (0x101335e48 in libR.dylib)
#> frame #62: forcePromise + 232 (0x1013366a8 in libR.dylib)
#> :
```
