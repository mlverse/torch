...
extern "C"
{
  ...
  LANTERN_API void*(LANTERN_PTR lantern_OptionalDeviceGuard_set_device)(void *device);
  LANTERN_API void(LANTERN_PTR lantern_OptionalDeviceGuard_delete)(void * x);
...
bool lanternInit(const std::string &libPath, std::string *pError)
{
  ...
  LOAD_SYMBOL(lantern_OptionalDeviceGuard_set_device);
  LOAD_SYMBOL(lantern_OptionalDeviceGuard_delete);
