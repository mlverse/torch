...
torch__amp_update_scale_ <- function(self, growth_tracker, found_inf, scale_growth_factor, scale_backoff_factor, growth_interval) {
  ...
  expected_types <- list(
    self = "Tensor", growth_tracker = "Tensor", found_inf = "Tensor",
...
#' @rdname torch__bmm
torch__bmm <- function(self, mat2, deterministic = FALSE) {
  args <- mget(x = c("self", "mat2", "deterministic"))
  expected_types <- list(self = "Tensor", mat2 = "Tensor", deterministic = "bool")
  nd_args <- c("self", "mat2")
  return_types <- list(list("Tensor"))
  call_c_function(
    fun_name = "_bmm",
...
#' @rdname torch__bmm_out
torch__bmm_out <- function(out, self, mat2, deterministic = FALSE) {
  args <- mget(x = c("out", "self", "mat2", "deterministic"))
  expected_types <- list(out = "Tensor", self = "Tensor", mat2 = "Tensor", deterministic = "bool")
...
torch__convolution_mode <- function(input, weight, bias, stride, padding, dilation, groups) {
  ...
  expected_types <- list(
    input = "Tensor", weight = "Tensor", bias = "Tensor", stride = "IntArrayRef",
    padding = "std::string", dilation = "IntArrayRef", groups = "int64_t"
  )
  nd_args <- c(
    "input", "weight", "bias", "stride", "padding", "dilation",
    "groups"
...
torch__cummax_helper <- function(self, values, indices, dim) {
  ...
  expected_types <- list(
    self = "Tensor", values = "Tensor", indices = "Tensor",
    dim = "int64_t"
  )
...
torch__embedding_bag_dense_backward <- function(grad, indices, offset2bag, bag_size, maximum_indices, num_weights, scale_grad_by_freq, mode, per_sample_weights, padding_idx = -1L) {
  ...
  expected_types <- list(
    grad = "Tensor", indices = "Tensor", offset2bag = "Tensor",
...
torch__fft_c2c <- function(self, dim, normalization, forward) {
  ...
  expected_types <- list(
    self = "Tensor", dim = "IntArrayRef", normalization = "int64_t",
    forward = "bool"
  )
...
torch__fft_c2c_out <- function(out, self, dim, normalization, forward) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", dim = "IntArrayRef", normalization = "int64_t",
    forward = "bool"
  )
...
torch__foreach_add <- function(tensors, tensors1, scalar, scalars, tensors2, alpha = 1L) {
  ...
  expected_types <- list(
    tensors = "TensorList", tensors1 = "TensorList", scalar = "Scalar",
...
torch__foreach_add_ <- function(self, other, scalar, scalars, alpha = 1L) {
  ...
  expected_types <- list(
    self = "TensorList", other = "TensorList", scalar = "Scalar",
...
torch__foreach_addcdiv <- function(input, tensor1, tensor2, scalars, value = 1L) {
  ...
  expected_types <- list(
    input = "TensorList", tensor1 = "TensorList", tensor2 = "TensorList",
...
torch__foreach_addcdiv_ <- function(self, tensor1, tensor2, scalars, value = 1L) {
  ...
  expected_types <- list(
    self = "TensorList", tensor1 = "TensorList", tensor2 = "TensorList",
    scalars = "ArrayRef<Scalar>", value = "Scalar"
  )
...
torch__index_put_impl_ <- function(self, indices, values, accumulate = FALSE, unsafe = FALSE) {
  ...
  expected_types <- list(
    self = "Tensor", indices = "const c10::List<c10::optional<Tensor>> &",
...
torch__linalg_qr_helper <- function(self, mode) {
  ...
  expected_types <- list(self = "Tensor", mode = "std::string")
  nd_args <- c("self", "mode")
  return_types <- list(list("Tensor", "Tensor"))
  call_c_function(
...
#' @rdname torch__linalg_solve_out_helper_
torch__linalg_solve_out_helper_ <- function(self, other, infos) {
  args <- mget(x = c("self", "other", "infos"))
  expected_types <- list(self = "Tensor", other = "Tensor", infos = "Tensor")
  nd_args <- c("self", "other", "infos")
  return_types <- list(list("Tensor"))
  call_c_function(
    fun_name = "_linalg_solve_out_helper_",
    args = args,
    expected_types = expected_types,
    nd_args = nd_args,
    return_types = return_types,
...
torch__remove_batch_dim <- function(self, level, batch_size, out_dim) {
  ...
  expected_types <- list(
    self = "Tensor", level = "int64_t", batch_size = "int64_t",
    out_dim = "int64_t"
  )
...
#' @rdname torch__sparse_csr_tensor
torch__sparse_csr_tensor <- function(crow_indices, col_indices, values, size, options) {
  args <- mget(x = c("crow_indices", "col_indices", "values", "size", "options"))
  expected_types <- list(
    crow_indices = "Tensor", col_indices = "Tensor", values = "Tensor",
    size = "IntArrayRef", options = "TensorOptions"
  )
  nd_args <- c("crow_indices", "col_indices", "values", "size", "options")
  return_types <- list(list("Tensor"))
  call_c_function(
    fun_name = "_sparse_csr_tensor",
    args = args,
    expected_types = expected_types,
    nd_args = nd_args,
    return_types = return_types,
...
torch__sparse_log_softmax <- function(self, dim, dtype = NULL, half_to_float) {
  ...
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), dtype = "ScalarType",
    half_to_float = "bool"
  )
  nd_args <- c("self", "dim", "half_to_float")
  return_types <- list(list("Tensor"))
...
torch_bucketize <- function(self, boundaries, out_int32 = FALSE, right = FALSE) {
  ...
  expected_types <- list(
    self = c("Tensor", "Scalar"), boundaries = "Tensor", out_int32 = "bool",
    right = "bool"
  )
...
torch_bucketize_out <- function(out, self, boundaries, out_int32 = FALSE, right = FALSE) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", boundaries = "Tensor",
...
torch_choose_qparams_optimized <- function(input, numel, n_bins, ratio, bit_width) {
  ...
  expected_types <- list(
    input = "Tensor", numel = "int64_t", n_bins = "int64_t",
...
torch_clamp <- function(self, min = NULL, max = NULL) {
  ...
  expected_types <- list(self = "Tensor", min = c("Scalar", "Tensor"), max = c(
    "Scalar",
    "Tensor"
  ))
...
torch_clamp_out <- function(out, self, min = NULL, max = NULL) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", min = c("Scalar", "Tensor"), max = c("Scalar", "Tensor"))
...
torch_conv1d <- function(input, weight, bias = list(), stride = 1L, padding = 0L, dilation = 1L, groups = 1L) {
  ...
  expected_types <- list(
    input = "Tensor", weight = "Tensor", bias = "Tensor", stride = "IntArrayRef",
    padding = c("IntArrayRef", "std::string"), dilation = "IntArrayRef",
    groups = "int64_t"
  )
...
torch_cudnn_convolution_add_relu <- function(self, weight, z, alpha, bias, stride, padding, dilation, groups) {
  ...
  expected_types <- list(
    self = "Tensor", weight = "Tensor", z = "Tensor", alpha = "Scalar",
    bias = "Tensor", stride = "IntArrayRef", padding = "IntArrayRef",
...
torch_cudnn_convolution_relu <- function(self, weight, bias, stride, padding, dilation, groups) {
  ...
  expected_types <- list(
    self = "Tensor", weight = "Tensor", bias = "Tensor", stride = "IntArrayRef",
...
torch_diagonal <- function(self, outdim, dim1 = 1L, dim2 = 2L, offset = 0L) {
  ...
  expected_types <- list(self = "Tensor", outdim = "Dimname", dim1 = c(
    "int64_t",
    "Dimname"
  ), dim2 = c("int64_t", "Dimname"), offset = "int64_t")
...
torch_diagonal_backward <- function(grad, input_sizes, offset, dim1, dim2) {
  args <- mget(x = c("grad", "input_sizes", "offset", "dim1", "dim2"))
  expected_types <- list(
    grad = "Tensor", input_sizes = "IntArrayRef", offset = "int64_t",
    dim1 = "int64_t", dim2 = "int64_t"
  )
  nd_args <- c("grad", "input_sizes", "offset", "dim1", "dim2")
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_diff <- function(self, n = 1L, dim = -1L, prepend = list(), append = list()) {
  ...
  expected_types <- list(
    self = "Tensor", n = "int64_t", dim = "int64_t", prepend = "Tensor",
    append = "Tensor"
  )
  nd_args <- "self"
  return_types <- list(list("Tensor"))
...
torch_diff_out <- function(out, self, n = 1L, dim = -1L, prepend = list(), append = list()) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", n = "int64_t", dim = "int64_t",
...
torch_div_out <- function(out, self, other, rounding_mode) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", other = "Tensor", rounding_mode = "std::string")
...
torch_elu_backward <- function(grad_output, alpha, scale, input_scale, is_result, self_or_result) {
  ...
  nd_args <- c(
    "grad_output", "alpha", "scale", "input_scale", "is_result",
    "self_or_result"
  )
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_embedding_bag <- function(weight, indices, offsets, scale_grad_by_freq = FALSE, mode = 0L, sparse = FALSE, per_sample_weights = list(), include_last_offset = FALSE, padding_idx) {
  ...
  nd_args <- c(
    "weight", "indices", "offsets", "scale_grad_by_freq", "mode",
...
torch_empty_quantized <- function(size, qtensor) {
  args <- mget(x = c("size", "qtensor"))
  expected_types <- list(size = "IntArrayRef", qtensor = "Tensor")
...
torch_fft_fft2 <- function(self, s = NULL, dim = c(-2, -1), norm = NULL) {
  ...
  expected_types <- list(
    self = "Tensor", s = "IntArrayRef", dim = "IntArrayRef",
    norm = "std::string"
  )
  nd_args <- "self"
  return_types <- list(list("Tensor"))
...
torch_fft_fft2_out <- function(out, self, s = NULL, dim = c(-2, -1), norm = NULL) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", s = "IntArrayRef", dim = "IntArrayRef",
    norm = "std::string"
  )
  nd_args <- c("out", "self")
  return_types <- list(list("Tensor"))
...
torch_gather_backward <- function(grad, self, dim, index, sparse_grad) {
  ...
  expected_types <- list(
    grad = "Tensor", self = "Tensor", dim = "int64_t", index = "Tensor",
    sparse_grad = "bool"
  )
...
torch_gradient <- function(self, spacing = NULL, dim = NULL, edge_order = 1L) {
  ...
  expected_types <- list(self = "Tensor", spacing = c(
    "Scalar", "ArrayRef<Scalar>",
    "TensorList"
  ), dim = c("int64_t", "IntArrayRef"), edge_order = "int64_t")
...
torch_huber_loss <- function(self, target, reduction = torch_reduction_mean(), delta = 1.000000) {
  ...
  expected_types <- list(
    self = "Tensor", target = "Tensor", reduction = "int64_t",
    delta = "double"
  )
  nd_args <- c("self", "target")
  return_types <- list(list("Tensor"))
...
torch_huber_loss_out <- function(out, self, target, reduction = torch_reduction_mean(), delta = 1.000000) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", target = "Tensor", reduction = "int64_t",
    delta = "double"
  )
  nd_args <- c("out", "self", "target")
  return_types <- list(list("Tensor"))
...
torch_index_select_backward <- function(grad, self_sizes, dim, index) {
  ...
  expected_types <- list(
    grad = "Tensor", self_sizes = "IntArrayRef", dim = "int64_t",
    index = "Tensor"
  )
...
.torch_kaiser_window <- function(window_length, periodic, beta, options = list()) {
  ...
  expected_types <- list(
    window_length = "int64_t", periodic = "bool", beta = "double",
    options = "TensorOptions"
  )
...
torch_leaky_relu_backward <- function(grad_output, self, negative_slope, self_is_result) {
  ...
  expected_types <- list(
    grad_output = "Tensor", self = "Tensor", negative_slope = "Scalar",
    self_is_result = "bool"
  )
...
torch_linalg_cholesky <- function(self) {
  args <- mget(x = c("self"))
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
  return_types <- list(list("Tensor"))
...
torch_linalg_cholesky_ex <- function(self, check_errors = FALSE) {
...
torch_linalg_cholesky_ex_out <- function(L, info, self, check_errors = FALSE) {
  args <- mget(x = c("L", "info", "self", "check_errors"))
  expected_types <- list(L = "Tensor", info = "Tensor", self = "Tensor", check_errors = "bool")
...
torch_linalg_cholesky_out <- function(out, self) {
  args <- mget(x = c("out", "self"))
  expected_types <- list(out = "Tensor", self = "Tensor")
  nd_args <- c("out", "self")
  return_types <- list(list("Tensor"))
...
torch_linalg_cond <- function(self, p = NULL) {
  args <- mget(x = c("self", "p"))
  expected_types <- list(self = "Tensor", p = c("Scalar", "std::string"))
  nd_args <- c("self", "p")
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_linalg_cond_out <- function(out, self, p = NULL) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", p = c("Scalar", "std::string"))
...
torch_linalg_eigh <- function(self, UPLO = "L") {
  ...
  expected_types <- list(self = "Tensor", UPLO = "std::string")
  nd_args <- "self"
  return_types <- list(list("Tensor", "Tensor"))
  call_c_function(
...
torch_linalg_eigh_out <- function(eigvals, eigvecs, self, UPLO = "L") {
  ...
  expected_types <- list(
    eigvals = "Tensor", eigvecs = "Tensor", self = "Tensor",
    UPLO = "std::string"
  )
...
torch_linalg_eigvalsh_out <- function(out, self, UPLO = "L") {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", UPLO = "std::string")
  nd_args <- c("out", "self")
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_linalg_lstsq <- function(self, b, rcond = NULL, driver = NULL) {
  ...
  expected_types <- list(self = "Tensor", b = "Tensor", rcond = "double", driver = "std::string")
  nd_args <- c("self", "b")
  return_types <- list(list("Tensor", "Tensor", "Tensor", "Tensor"))
  call_c_function(
...
torch_linalg_lstsq_out <- function(solution, residuals, rank, singular_values, self, b, rcond = NULL, driver = NULL) {
  ...
  expected_types <- list(
    ...
    rcond = "double", driver = "std::string"
  )
  nd_args <- c(
    "solution", "residuals", "rank", "singular_values", "self",
    "b"
  )
  return_types <- list(list("Tensor", "Tensor", "Tensor", "Tensor"))
  call_c_function(
...
torch_linalg_matrix_norm <- function(self, ord = "fro", dim = c(-2, -1), keepdim = FALSE, dtype = NULL) {
  ...
  expected_types <- list(
    self = "Tensor", ord = c("Scalar", "std::string"), dim = "IntArrayRef",
...
torch_linalg_matrix_norm_out <- function(out, self, ord = "fro", dim = c(-2, -1), keepdim = FALSE, dtype = NULL) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", ord = c("Scalar", "std::string"), dim = "IntArrayRef", keepdim = "bool", dtype = "ScalarType")
...
torch_linalg_matrix_rank <- function(input, self, tol = NULL, hermitian = FALSE) {
  ...
  expected_types <- list(input = "Tensor", self = "Tensor", tol = c("double", "Tensor"), hermitian = "bool")
...
torch_linalg_matrix_rank_out <- function(out, input, self, tol = NULL, hermitian = FALSE) {
  ...
  expected_types <- list(out = "Tensor", input = "Tensor", self = "Tensor", tol = c(
    "double",
    "Tensor"
  ), hermitian = "bool")
...
torch_linalg_pinv_out <- function(out, self, rcond = 0.000000, hermitian = FALSE) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", rcond = c("double", "Tensor"), hermitian = "bool")
...
torch_linalg_qr_out <- function(Q, R, self, mode = "reduced") {
  ...
  expected_types <- list(Q = "Tensor", R = "Tensor", self = "Tensor", mode = "std::string")
  nd_args <- c("Q", "R", "self")
  return_types <- list(list("Tensor", "Tensor"))
  call_c_function(
...
torch_linalg_svd_out <- function(U, S, Vh, self, full_matrices = TRUE) {
  ...
  expected_types <- list(
    U = "Tensor", S = "Tensor", Vh = "Tensor", self = "Tensor",
    full_matrices = "bool"
  )
...
torch_linalg_vector_norm <- function(self, ord = 2L, dim = NULL, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("self", "ord", "dim", "keepdim", "dtype"))
  expected_types <- list(
    self = "Tensor", ord = "Scalar", dim = "IntArrayRef", keepdim = "bool",
    dtype = "ScalarType"
  )
  nd_args <- "self"
  return_types <- list(list("Tensor"))
...
torch_linalg_vector_norm_out <- function(out, self, ord = 2L, dim = NULL, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("out", "self", "ord", "dim", "keepdim", "dtype"))
  expected_types <- list(
    out = "Tensor", self = "Tensor", ord = "Scalar", dim = "IntArrayRef",
    keepdim = "bool", dtype = "ScalarType"
  )
  nd_args <- c("out", "self")
  return_types <- list(list("Tensor"))
...
torch_lu_unpack <- function(LU_data, LU_pivots, unpack_data = TRUE, unpack_pivots = TRUE) {
  ...
  expected_types <- list(
    LU_data = "Tensor", LU_pivots = "Tensor", unpack_data = "bool",
    unpack_pivots = "bool"
  )
...
torch_lu_unpack_out <- function(P, L, U, LU_data, LU_pivots, unpack_data = TRUE, unpack_pivots = TRUE) {
  ...
  expected_types <- list(
    P = "Tensor", L = "Tensor", U = "Tensor", LU_data = "Tensor",
...
torch_mkldnn_max_pool2d_backward <- function(grad_output, output, input, kernel_size, stride = list(), padding = 0L, dilation = 1L, ceil_mode = FALSE) {
  ...
  expected_types <- list(
    grad_output = "Tensor", output = "Tensor", input = "Tensor",
    kernel_size = "IntArrayRef", stride = "IntArrayRef", padding = "IntArrayRef",
...
torch_moveaxis <- function(self, source, destination) {
  ...
  expected_types <- list(self = "Tensor", source = c("IntArrayRef", "int64_t"), destination = c(
    "IntArrayRef",
    "int64_t"
  ))
...
torch_nan_to_num_out <- function(out, self, nan = NULL, posinf = NULL, neginf = NULL) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", nan = "double", posinf = "double",
    neginf = "double"
  )
  nd_args <- c("out", "self")
  return_types <- list(list("Tensor"))
...
torch_nanquantile <- function(self, q, dim = NULL, keepdim = FALSE, interpolation) {
  ...
  expected_types <- list(
    self = "Tensor", q = c("double", "Tensor"), dim = "int64_t",
...
torch_nanquantile_out <- function(out, self, q, dim = NULL, keepdim = FALSE, interpolation) {
  ...
  expected_types <- list(out = "Tensor", self = "Tensor", q = c("double", "Tensor"), dim = "int64_t", keepdim = "bool", interpolation = "std::string")
...
torch_nansum <- function(self, dim, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("self", "dim", "keepdim", "dtype"))
  expected_types <- list(
    self = "Tensor", dim = "IntArrayRef", keepdim = "bool",
    dtype = "ScalarType"
  )
  nd_args <- c("self", "dim")
  return_types <- list(list("Tensor"))
...
torch_nansum_out <- function(out, self, dim, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("out", "self", "dim", "keepdim", "dtype"))
  expected_types <- list(
    out = "Tensor", self = "Tensor", dim = "IntArrayRef", keepdim = "bool",
    dtype = "ScalarType"
  )
  nd_args <- c("out", "self", "dim")
  return_types <- list(list("Tensor"))
...
.torch_narrow <- function(self, dim, start, length) {
  ...
  expected_types <- list(self = "Tensor", dim = "int64_t", start = c("int64_t", "Tensor"), length = "int64_t")
...
torch_narrow_copy_out <- function(out, self, dim, start, length) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", dim = "int64_t", start = "int64_t",
    length = "int64_t"
  )
...
torch_native_batch_norm_out <- function(out, save_mean, save_invstd, input, weight, bias, running_mean, running_var, training, momentum, eps) {
  ...
  expected_types <- list(
    out = "Tensor", save_mean = "Tensor", save_invstd = "Tensor",
    input = "Tensor", weight = "Tensor", bias = "Tensor", running_mean = "Tensor",
    running_var = "Tensor", training = "bool", momentum = "double",
    eps = "double"
  )
...
torch_native_group_norm <- function(input, weight, bias, False, C, HxW, group, eps) {
  ...
  expected_types <- list(
    input = "Tensor", weight = "Tensor", bias = "Tensor", False = "int64_t",
...
torch_native_group_norm_backward <- function(grad_out, input, mean, rstd, weight, False, C, HxW, group, output_mask) {
  ...
  nd_args <- c(
    "grad_out", "input", "mean", "rstd", "weight", "False", "C",
...
torch_native_layer_norm_backward <- function(grad_out, input, normalized_shape, mean, rstd, weight, bias, output_mask) {
  ...
  expected_types <- list(
    grad_out = "Tensor", input = "Tensor", normalized_shape = "IntArrayRef",
    mean = "Tensor", rstd = "Tensor", weight = "Tensor", bias = "Tensor",
    output_mask = "std::array<bool,3>"
  )
  nd_args <- c(
    "grad_out", "input", "normalized_shape", "mean", "rstd", "weight",
    "bias", "output_mask"
  )
  return_types <- list(list("Tensor", "Tensor", "Tensor"))
  call_c_function(
...
torch_native_norm <- function(self, p = 2L, dim, keepdim, dtype) {
  ...
  expected_types <- list(
    self = "Tensor", p = "Scalar", dim = "IntArrayRef", keepdim = "bool",
    dtype = "ScalarType"
  )
...
.torch_quantize_per_tensor <- function(self, tensors, scale, scales, zero_point, zero_points, dtype) {
  ...
  expected_types <- list(
    self = "Tensor", tensors = "TensorList", scale = "double",
    scales = "Tensor", zero_point = "int64_t", zero_points = "Tensor",
    dtype = "ScalarType"
  )
  nd_args <- c(
    "self", "tensors", "scale", "scales", "zero_point", "zero_points",
    "dtype"
  )
  return_types <- list(list("Tensor"), list("TensorList"))
  call_c_function(
...
torch_quantized_batch_norm <- function(input, weight, bias, mean, var, eps, output_scale, output_zero_point) {
  ...
  nd_args <- c(
    "input", "weight", "bias", "mean", "var", "eps", "output_scale",
    "output_zero_point"
  )
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_repeat_interleave <- function(self, repeats, dim = NULL) {
  args <- mget(x = c("self", "repeats", "dim"))
...
torch_rrelu_with_noise_backward <- function(grad_output, self, noise, lower, upper, training, self_is_result) {
  ...
  nd_args <- c(
    "grad_output", "self", "noise", "lower", "upper", "training",
    "self_is_result"
  )
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_scatter <- function(self, dim, index, src, value) {
  args <- mget(x = c("self", "dim", "index", "src", "value"))
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), index = "Tensor",
...
torch_searchsorted <- function(sorted_sequence, self, out_int32 = FALSE, right = FALSE) {
  ...
  expected_types <- list(
    sorted_sequence = "Tensor", self = c("Tensor", "Scalar"),
    out_int32 = "bool", right = "bool"
  )
...
torch_searchsorted_out <- function(out, sorted_sequence, self, out_int32 = FALSE, right = FALSE) {
  ...
  expected_types <- list(
    out = "Tensor", sorted_sequence = "Tensor", self = "Tensor",
    out_int32 = "bool", right = "bool"
  )
...
torch_segment_reduce <- function(data, reduce, lengths = list(), indices = list(), axis = 0L, unsafe = FALSE, initial = NULL) {
  ...
  expected_types <- list(
    data = "Tensor", reduce = "std::string", lengths = "Tensor",
...
#' @rdname torch_segment_reduce_backward
torch_segment_reduce_backward <- function(grad, output, data, lengths = list()) {
  args <- mget(x = c("grad", "output", "data", "lengths"))
  expected_types <- list(grad = "Tensor", output = "Tensor", data = "Tensor", lengths = "Tensor")
  nd_args <- c("grad", "output", "data")
  return_types <- list(list("Tensor"))
  call_c_function(
    fun_name = "segment_reduce_backward",
    args = args,
    expected_types = expected_types,
    nd_args = nd_args,
    return_types = return_types,
...
torch_select_backward <- function(grad, input_sizes, dim, index) {
  args <- mget(x = c("grad", "input_sizes", "dim", "index"))
  expected_types <- list(
    grad = "Tensor", input_sizes = "IntArrayRef", dim = "int64_t",
    index = "int64_t"
  )
  nd_args <- c("grad", "input_sizes", "dim", "index")
  return_types <- list(list("Tensor"))
  call_c_function(
...
torch_slice_backward <- function(grad, input_sizes, dim, start, end, step) {
  args <- mget(x = c("grad", "input_sizes", "dim", "start", "end", "step"))
  expected_types <- list(
    grad = "Tensor", input_sizes = "IntArrayRef", dim = "int64_t",
    start = "int64_t", end = "int64_t", step = "int64_t"
  )
  nd_args <- c("grad", "input_sizes", "dim", "start", "end", "step")
  return_types <- list(list("Tensor"))
  call_c_function(
...
.torch_sort <- function(self, dim = -1L, descending = FALSE, stable) {
  ...
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), descending = "bool",
    stable = "bool"
  )
...
torch_special_xlog1py_out <- function(out, self, other) {
  args <- mget(x = c("out", "self", "other"))
  expected_types <- list(out = "Tensor", self = c("Tensor", "Scalar"), other = c(
    "Tensor",
    "Scalar"
  ))
  nd_args <- c("out", "self", "other")
...
torch_tensor_split <- function(self, indices, sections, tensor_indices_or_sections, dim = 1L) {
  ...
  expected_types <- list(
    self = "Tensor", indices = "IntArrayRef", sections = "int64_t",
...
torch_tensordot_out <- function(out, self, other, dims_self, dims_other) {
  ...
  expected_types <- list(
    out = "Tensor", self = "Tensor", other = "Tensor", dims_self = "IntArrayRef",
    dims_other = "IntArrayRef"
  )
...
#' @rdname torch_thnn_conv_depthwise2d
torch_thnn_conv_depthwise2d <- function(self, weight, kernel_size, bias = list(), stride = 1L, padding = 0L, dilation = 1L) {
  args <- mget(x = c("self", "weight", "kernel_size", "bias", "stride", "padding", "dilation"))
  expected_types <- list(
    self = "Tensor", weight = "Tensor", kernel_size = "IntArrayRef",
    bias = "Tensor", stride = "IntArrayRef", padding = "IntArrayRef",
...
#' @rdname torch_thnn_conv_depthwise2d_backward
...
#' @rdname torch_thnn_conv_depthwise2d_backward_out
...
#' @rdname torch_thnn_conv_depthwise2d_forward
...
#' @rdname torch_thnn_conv_depthwise2d_forward_out
...
#' @rdname torch_thnn_conv_depthwise2d_out
torch_thnn_conv_depthwise2d_out <- function(out, self, weight, kernel_size, bias = list(), stride = 1L, padding = 0L, dilation = 1L) {
  args <- mget(x = c("out", "self", "weight", "kernel_size", "bias", "stride", "padding", "dilation"))
  expected_types <- list(
    out = "Tensor", self = "Tensor", weight = "Tensor", kernel_size = "IntArrayRef",
    bias = "Tensor", stride = "IntArrayRef", padding = "IntArrayRef",
...
#' @rdname torch_thnn_conv2d_backward
...
#' @rdname torch_thnn_conv2d_backward_out
...
#' @rdname torch_thnn_conv2d_forward
...
#' @rdname torch_thnn_conv2d_forward_out
...
torch_unfold_backward <- function(grad_in, input_sizes, dim, size, step) {
  ...
  expected_types <- list(
    grad_in = "Tensor", input_sizes = "IntArrayRef", dim = "int64_t",
...
torch_upsample_bicubic2d <- function(input, self, output_size, align_corners, scale_factors, scales_h = NULL, scales_w = NULL) {
  ...
  expected_types <- list(
    input = "Tensor", self = "Tensor", output_size = "IntArrayRef",
...
torch_value_selecting_reduction_backward <- function(grad, dim, indices, sizes, keepdim) {
  ...
  expected_types <- list(
    grad = "Tensor", dim = "int64_t", indices = "Tensor", sizes = "IntArrayRef",
    keepdim = "bool"
  )
...
torch_where <- function(condition, self, other) {
  args <- mget(x = c("condition", "self", "other"))
  expected_types <- list(condition = "Tensor", self = c("Tensor", "Scalar"), other = c(
    "Tensor",
    "Scalar"
  ))
  nd_args <- c("condition", "self", "other")
