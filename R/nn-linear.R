...
#' - bias: the learnable bias of the module of shape :math:\eqn{(\mbox{out_features})}.
#'   If `bias` is `TRUE`, the values are initialized from
#'   \eqn{\mathcal{U}(-\sqrt{k}, \sqrt{k})} where
#'   \eqn{k = \frac{1}{\mbox{in_features}}}
#'   
#' @examples 
#' m <- nn_linear(20, 30)
#' input <- torch_randn(128, 20)
...
#' @section Shape:
#' 
#' - Input1: \eqn{(N, *, H_{in1})} \eqn{H_{in1}=\mbox{in1_features}} and
#'   \eqn{*} means any number of additional dimensions. All but the last 
#'   dimension of the inputs should be the same.
#' - Input2: \eqn{(N, *, H_{in2})} where \eqn{H_{in2}=\mbox{in2_features}}.
#' - Output: \eqn{(N, *, H_{out})} where \eqn{H_{out}=\mbox{out_features}}
#'   and all but the last dimension are the same shape as the input.
#'
#' @section Attributes:
#'   
#' - weight: the learnable weights of the module of shape
#'   \eqn{(\mbox{out_features}, \mbox{in1_features}, \mbox{in2_features})}.
#'   The values are initialized from \eqn{\mathcal{U}(-\sqrt{k}, \sqrt{k})}, where
#'   \eqn{k = \frac{1}{\mbox{in1_features}}}
#' - bias: the learnable bias of the module of shape \eqn{(\mbox{out_features})}.
#'   If `bias` is `TRUE`, the values are initialized from
#'   \eqn{\mathcal{U}(-\sqrt{k}, \sqrt{k})}, where 
#'   \eqn{k = \frac{1}{\mbox{in1_features}}}
#'   
