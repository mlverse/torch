...
#' @include tensor.R
Tensor$set("public", "__and__", function(other) {
  args <- mget(x = c("other"))
...
Tensor$set("private", "__backward", function(inputs, gradient = list(), retain_graph = NULL, create_graph = FALSE) {
  args <- mget(x = c("inputs", "gradient", "retain_graph", "create_graph"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", inputs = "TensorList", gradient = "Tensor",
...
Tensor$set("public", "_fw_primal", function(level) {
  args <- mget(x = c("level"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "absolute", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "absolute_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "acosh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "acosh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "add", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "add_", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), alpha = "Scalar")
  nd_args <- c("self", "other")
...
Tensor$set("public", "addbmm", function(batch1, batch2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("batch1", "batch2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "addbmm_", function(batch1, batch2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("batch1", "batch2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", batch1 = "Tensor", batch2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "addcdiv", function(tensor1, tensor2, value = 1L) {
  args <- mget(x = c("tensor1", "tensor2", "value"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "addcdiv_", function(tensor1, tensor2, value = 1L) {
  args <- mget(x = c("tensor1", "tensor2", "value"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", tensor1 = "Tensor", tensor2 = "Tensor",
...
Tensor$set("public", "addcmul", function(tensor1, tensor2, value = 1L) {
  args <- mget(x = c("tensor1", "tensor2", "value"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", tensor1 = "Tensor", tensor2 = "Tensor",
...
Tensor$set("public", "addcmul_", function(tensor1, tensor2, value = 1L) {
  args <- mget(x = c("tensor1", "tensor2", "value"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", tensor1 = "Tensor", tensor2 = "Tensor",
...
Tensor$set("public", "addmm", function(mat1, mat2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("mat1", "mat2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "addmm_", function(mat1, mat2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("mat1", "mat2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", mat1 = "Tensor", mat2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "addmv", function(mat, vec, beta = 1L, alpha = 1L) {
  args <- mget(x = c("mat", "vec", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "addmv_", function(mat, vec, beta = 1L, alpha = 1L) {
  args <- mget(x = c("mat", "vec", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", mat = "Tensor", vec = "Tensor", beta = "Scalar",
...
Tensor$set("public", "addr", function(vec1, vec2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("vec1", "vec2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "addr_", function(vec1, vec2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("vec1", "vec2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", vec1 = "Tensor", vec2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "align_to", function(names, order, ellipsis_idx) {
  args <- mget(x = c("names", "order", "ellipsis_idx"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", names = "DimnameList", order = "DimnameList",
...
Tensor$set("public", "allclose", function(other, rtol = 0.000010, atol = 0.000000, equal_nan = FALSE) {
  args <- mget(x = c("other", "rtol", "atol", "equal_nan"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "amax", function(dim = list(), keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "amin", function(dim = list(), keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = "IntArrayRef", keepdim = "bool")
  nd_args <- "self"
...
Tensor$set("public", "arccos", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arccos_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arccosh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arccosh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arcsin", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arcsin_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arcsinh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arcsinh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arctan", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arctan_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arctanh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "arctanh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_argmax", function(dim = NULL, keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
...
Tensor$set("private", "_argmin", function(dim = NULL, keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = "int64_t", keepdim = "bool")
  nd_args <- "self"
...
Tensor$set("private", "_argsort", function(dim = -1L, descending = FALSE) {
  args <- mget(x = c("dim", "descending"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "as_strided", function(size, stride, storage_offset = NULL) {
  args <- mget(x = c("size", "stride", "storage_offset"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "asinh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "asinh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "atanh", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "atanh_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "baddbmm", function(batch1, batch2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("batch1", "batch2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", batch1 = "Tensor", batch2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "baddbmm_", function(batch1, batch2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("batch1", "batch2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", batch1 = "Tensor", batch2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "bincount", function(weights = list(), minlength = 0L) {
  args <- mget(x = c("weights", "minlength"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "bitwise_and", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "bitwise_and_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "bitwise_or", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "bitwise_or_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "broadcast_to", function(size) {
  args <- mget(x = c("size"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "cauchy_", function(median = 0L, sigma = 1L, generator = NULL) {
  args <- mget(x = c("median", "sigma", "generator"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "chunk", function(chunks, dim = 1L) {
  args <- mget(x = c("chunks", "dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "clip", function(min = NULL, max = NULL) {
  args <- mget(x = c("min", "max"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", min = c("Scalar", "Tensor"), max = c(
    "Scalar",
...
Tensor$set("public", "clip_", function(min = NULL, max = NULL) {
  args <- mget(x = c("min", "max"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", min = c("Scalar", "Tensor"), max = c(
    "Scalar",
...
Tensor$set("public", "clone", function(memory_format = NULL) {
  args <- mget(x = c("memory_format"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "col_indices", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_copy_", function(src, non_blocking = FALSE) {
  args <- mget(x = c("src", "non_blocking"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "copysign", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "copysign_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "count_nonzero", function(dim = NULL) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "crow_indices", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "cummax", function(dim) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "cummin", function(dim) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"))
  nd_args <- c("self", "dim")
...
Tensor$set("public", "cumprod_", function(dim, dtype = NULL) {
  args <- mget(x = c("dim", "dtype"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"), dtype = "ScalarType")
  nd_args <- c("self", "dim")
...
Tensor$set("public", "cumsum_", function(dim, dtype = NULL) {
  args <- mget(x = c("dim", "dtype"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"), dtype = "ScalarType")
  nd_args <- c("self", "dim")
...
Tensor$set("public", "deg2rad", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "deg2rad_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "diag", function(diagonal = 0L) {
  args <- mget(x = c("diagonal"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "diag_embed", function(offset = 0L, dim1 = -2L, dim2 = -1L) {
  args <- mget(x = c("offset", "dim1", "dim2"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "diagflat", function(offset = 0L) {
  args <- mget(x = c("offset"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "diagonal", function(outdim, dim1 = 1L, dim2 = 2L, offset = 0L) {
  args <- mget(x = c("outdim", "dim1", "dim2", "offset"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "diff", function(n = 1L, dim = -1L, prepend = list(), append = list()) {
  args <- mget(x = c("n", "dim", "prepend", "append"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "dist", function(other, p = 2L) {
  args <- mget(x = c("other", "p"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "div", function(other, rounding_mode) {
...
Tensor$set("public", "div_", function(other, rounding_mode) {
  args <- mget(x = c("other", "rounding_mode"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), rounding_mode = "std::string")
  nd_args <- c("self", "other", "rounding_mode")
...
Tensor$set("public", "divide", function(other, rounding_mode) {
  args <- mget(x = c("other", "rounding_mode"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), rounding_mode = "std::string")
  nd_args <- c("self", "other", "rounding_mode")
...
Tensor$set("public", "divide_", function(other, rounding_mode) {
  args <- mget(x = c("other", "rounding_mode"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), rounding_mode = "std::string")
  nd_args <- c("self", "other", "rounding_mode")
...
Tensor$set("public", "dsplit", function(indices, sections) {
  args <- mget(x = c("indices", "sections"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "exp2", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "exp2_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "exponential_", function(lambd = 1L, generator = NULL) {
  args <- mget(x = c("lambd", "generator"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "fix", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "fix_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "flatten", function(dims, start_dim = 1L, end_dim = -1L, out_dim) {
  args <- mget(x = c("dims", "start_dim", "end_dim", "out_dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "fliplr", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "flipud", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "float_power", function(exponent) {
  args <- mget(x = c("exponent"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "float_power_", function(exponent) {
  args <- mget(x = c("exponent"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "floor_divide", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "floor_divide_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "fmax", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "fmin", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "frexp", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "gather", function(dim, index, sparse_grad = FALSE) {
  args <- mget(x = c("dim", "index", "sparse_grad"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "gcd", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "gcd_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "greater", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "greater_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "greater_equal", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "greater_equal_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "heaviside", function(values) {
  args <- mget(x = c("values"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "heaviside_", function(values) {
  args <- mget(x = c("values"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", values = "Tensor")
  nd_args <- c("self", "values")
...
Tensor$set("public", "histc", function(bins = 100L, min = 0L, max = 0L) {
  args <- mget(x = c("bins", "min", "max"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "hsplit", function(indices, sections) {
  args <- mget(x = c("indices", "sections"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", indices = "IntArrayRef", sections = "int64_t")
  nd_args <- c("self", "indices", "sections")
...
Tensor$set("public", "hypot", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "hypot_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "i0_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "igamma", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "igamma_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "igammac", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "igammac_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "index_add", function(dim, index, source, alpha = 1L) {
  args <- mget(x = c("dim", "index", "source", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), index = "Tensor",
...
Tensor$set("public", "index_add_", function(dim, index, source, alpha) {
  args <- mget(x = c("dim", "index", "source", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = "int64_t", index = "Tensor", source = "Tensor",
    alpha = "Scalar"
  )
  nd_args <- c("self", "dim", "index", "source", "alpha")
  return_types <- list(list("Tensor"))
...
Tensor$set("public", "index_copy", function(dim, index, source) {
  args <- mget(x = c("dim", "index", "source"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), index = "Tensor",
    source = "Tensor"
...
Tensor$set("public", "index_put", function(indices, values, accumulate = FALSE) {
  args <- mget(x = c("indices", "values", "accumulate"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "inner", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("private", "_is_leaf", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isfinite", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isinf", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isnan", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isneginf", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isposinf", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "isreal", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "istft", function(n_fft, hop_length = NULL, win_length = NULL, window = list(), center = TRUE, normalized = FALSE, onesided = NULL, length = NULL, return_complex = FALSE) {
  args <- mget(x = c("n_fft", "hop_length", "win_length", "window", "center", "normalized", "onesided", "length", "return_complex"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "kron", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "kthvalue", function(k, dim = -1L, keepdim = FALSE) {
  args <- mget(x = c("k", "dim", "keepdim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "lcm", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "lcm_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "ldexp", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "ldexp_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "less", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "less_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "less_equal", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "less_equal_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "log_normal_", function(mean = 1L, std = 2L, generator = NULL) {
  args <- mget(x = c("mean", "std", "generator"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "logaddexp", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logaddexp2", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logcumsumexp", function(dim) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"))
  nd_args <- c("self", "dim")
...
Tensor$set("public", "logical_and", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logical_and_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logical_or", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logical_or_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "logit", function(eps = NULL) {
  args <- mget(x = c("eps"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "logit_", function(eps = NULL) {
  args <- mget(x = c("eps"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", eps = "double")
  nd_args <- "self"
...
Tensor$set("public", "lu_solve", function(LU_data, LU_pivots) {
  args <- mget(x = c("LU_data", "LU_pivots"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "matrix_exp", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_max", function(dim, other, keepdim = FALSE) {
  args <- mget(x = c("dim", "other", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "maximum", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "mean", function(dim, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("dim", "keepdim", "dtype"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("IntArrayRef", "DimnameList"),
...
Tensor$set("private", "_min", function(dim, other, keepdim = FALSE) {
  args <- mget(x = c("dim", "other", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), other = "Tensor",
...
Tensor$set("public", "minimum", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "mode", function(dim = -1L, keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"), keepdim = "bool")
  nd_args <- c("self", "dim")
...
Tensor$set("public", "moveaxis", function(source, destination) {
  args <- mget(x = c("source", "destination"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "movedim", function(source, destination) {
  args <- mget(x = c("source", "destination"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", source = c("IntArrayRef", "int64_t"), destination = c(
    "IntArrayRef",
...
Tensor$set("public", "msort", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "multinomial", function(num_samples, replacement = FALSE, generator = NULL) {
  args <- mget(x = c("num_samples", "replacement", "generator"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "multiply", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "multiply_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "nan_to_num", function(nan = NULL, posinf = NULL, neginf = NULL) {
  args <- mget(x = c("nan", "posinf", "neginf"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "nan_to_num_", function(nan = NULL, posinf = NULL, neginf = NULL) {
  args <- mget(x = c("nan", "posinf", "neginf"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", nan = "double", posinf = "double", neginf = "double")
  nd_args <- "self"
...
Tensor$set("public", "nanmedian", function(dim, keepdim = FALSE) {
  args <- mget(x = c("dim", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"), keepdim = "bool")
  nd_args <- c("self", "dim")
...
Tensor$set("public", "nanquantile", function(q, dim = NULL, keepdim = FALSE, interpolation) {
  args <- mget(x = c("q", "dim", "keepdim", "interpolation"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "nansum", function(dim, keepdim = FALSE, dtype = NULL) {
  args <- mget(x = c("dim", "keepdim", "dtype"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("private", "_narrow", function(dim, start, length) {
  args <- mget(x = c("dim", "start", "length"))
  args <- append(list(self = self), args)
...
Tensor$set("private", "_narrow_copy", function(dim, start, length) {
  args <- mget(x = c("dim", "start", "length"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "negative", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "negative_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "new_empty_strided", function(size, stride, options = list()) {
...
Tensor$set("public", "new_full", function(size, fill_value, options = list()) {
  args <- mget(x = c("size", "fill_value", "options"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", size = "IntArrayRef", fill_value = "Scalar",
    options = "TensorOptions"
  )
...
Tensor$set("public", "nextafter", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("public", "nextafter_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("private", "_nonzero", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_nonzero_numpy", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_norm", function(p = 2L, dim, keepdim = FALSE, dtype) {
  args <- mget(x = c("p", "dim", "keepdim", "dtype"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "normal_", function(mean = 0L, std = 1L, generator = NULL) {
  args <- mget(x = c("mean", "std", "generator"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", mean = "double", std = "double", generator = "Generator")
  nd_args <- "self"
...
Tensor$set("public", "not_equal", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "not_equal_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Scalar", "Tensor"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "ormqr", function(input2, input3, left = TRUE, transpose = FALSE) {
  args <- mget(x = c("input2", "input3", "left", "transpose"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "outer", function(vec2) {
  args <- mget(x = c("vec2"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", vec2 = "Tensor")
  nd_args <- c("self", "vec2")
...
Tensor$set("public", "positive", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "prelu_backward", function(grad_output, weight) {
  args <- mget(x = c("grad_output", "weight"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "put", function(index, source, accumulate = FALSE) {
  args <- mget(x = c("index", "source", "accumulate"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "quantile", function(q, dim = NULL, keepdim = FALSE, interpolation) {
  args <- mget(x = c("q", "dim", "keepdim", "interpolation"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", q = c("double", "Tensor"), dim = "int64_t",
...
Tensor$set("public", "rad2deg", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "rad2deg_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "random_", function(from, to, generator = NULL) {
  args <- mget(x = c("from", "to", "generator"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "ravel", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "record_stream", function(s) {
  args <- mget(x = c("s"))
  args <- append(list(self = self), args)
...
Tensor$set("private", "_rename", function(names) {
  args <- mget(x = c("names"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", names = "DimnameList")
  nd_args <- c("self", "names")
...
Tensor$set("private", "_rename_", function(names) {
  args <- mget(x = c("names"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", names = "DimnameList")
  nd_args <- c("self", "names")
...
Tensor$set("public", "resize_", function(size, memory_format = NULL) {
  args <- mget(x = c("size", "memory_format"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "resize_as_", function(the_template, memory_format = NULL) {
  args <- mget(x = c("the_template", "memory_format"))
  args <- append(list(self = self), args)
...
Tensor$set("private", "_retain_grad", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "rot90", function(k = 1L, dims = c(0, 1)) {
  args <- mget(x = c("k", "dims"))
  args <- append(list(self = self), args)
...
Tensor$set("private", "_scatter", function(dim, index, src, value) {
  args <- mget(x = c("dim", "index", "src", "value"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), index = "Tensor",
...
Tensor$set("private", "_scatter_", function(dim, index, src, value, reduce) {
  args <- mget(x = c("dim", "index", "src", "value", "reduce"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = "int64_t", index = "Tensor", src = "Tensor",
...
Tensor$set("public", "set_", function(source, storage_offset, size, stride = list()) {
  args <- mget(x = c("source", "storage_offset", "size", "stride"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", source = c("Storage", "Tensor"), storage_offset = "int64_t",
...
Tensor$set("public", "sgn", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "sgn_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "signbit", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "sinc", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "sinc_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("private", "_size", function(dim) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "slice", function(dim = 1L, start = NULL, end = NULL, step = 1L) {
  args <- mget(x = c("dim", "start", "end", "step"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("private", "_sort", function(dim = -1L, descending = FALSE, stable) {
  args <- mget(x = c("dim", "descending", "stable"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "sparse_resize_", function(size, sparse_dim, dense_dim) {
  args <- mget(x = c("size", "sparse_dim", "dense_dim"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", size = "IntArrayRef", sparse_dim = "int64_t",
    dense_dim = "int64_t"
  )
...
Tensor$set("private", "_split", function(split_size, dim = 1L) {
  args <- mget(x = c("split_size", "dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "split_with_sizes", function(split_sizes, dim = 1L) {
  args <- mget(x = c("split_sizes", "dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "square", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "square_", function() {
  args <- list()
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor")
  nd_args <- "self"
...
Tensor$set("public", "sspaddmm", function(mat1, mat2, beta = 1L, alpha = 1L) {
  args <- mget(x = c("mat1", "mat2", "beta", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", mat1 = "Tensor", mat2 = "Tensor", beta = "Scalar",
...
Tensor$set("public", "std", function(dim, correction, unbiased = TRUE, keepdim = FALSE) {
  args <- mget(x = c("dim", "correction", "unbiased", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("IntArrayRef", "DimnameList"),
...
Tensor$set("public", "stft", function(n_fft, hop_length = NULL, win_length = NULL, window = list(), normalized = FALSE, onesided = NULL, return_complex = NULL) {
  args <- mget(x = c("n_fft", "hop_length", "win_length", "window", "normalized", "onesided", "return_complex"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", n_fft = "int64_t", hop_length = "int64_t",
...
Tensor$set("private", "_stride", function(dim) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"))
  nd_args <- c("self", "dim")
...
Tensor$set("public", "sub", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), alpha = "Scalar")
  nd_args <- c("self", "other")
...
Tensor$set("public", "sub_", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), alpha = "Scalar")
  nd_args <- c("self", "other")
...
Tensor$set("public", "subtract", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), alpha = "Scalar")
  nd_args <- c("self", "other")
...
Tensor$set("public", "subtract_", function(other, alpha = 1L) {
  args <- mget(x = c("other", "alpha"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"), alpha = "Scalar")
  nd_args <- c("self", "other")
...
Tensor$set("public", "swapaxes", function(axis0, axis1) {
  args <- mget(x = c("axis0", "axis1"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "swapaxes_", function(axis0, axis1) {
  args <- mget(x = c("axis0", "axis1"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", axis0 = "int64_t", axis1 = "int64_t")
  nd_args <- c("self", "axis0", "axis1")
...
Tensor$set("public", "swapdims", function(dim0, dim1) {
  args <- mget(x = c("dim0", "dim1"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "swapdims_", function(dim0, dim1) {
  args <- mget(x = c("dim0", "dim1"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim0 = "int64_t", dim1 = "int64_t")
  nd_args <- c("self", "dim0", "dim1")
...
Tensor$set("public", "symeig", function(eigenvectors = FALSE, upper = TRUE) {
  args <- mget(x = c("eigenvectors", "upper"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "take_along_dim", function(indices, dim = NULL) {
  args <- mget(x = c("indices", "dim"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "tensor_split", function(indices, sections, tensor_indices_or_sections, dim = 1L) {
  args <- mget(x = c("indices", "sections", "tensor_indices_or_sections", "dim"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "tile", function(dims) {
  args <- mget(x = c("dims"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dims = "IntArrayRef")
  nd_args <- c("self", "dims")
...
Tensor$set("private", "_to", function(device, options = list(), other, dtype, non_blocking = FALSE, copy = FALSE, memory_format = NULL) {
  args <- mget(x = c("device", "options", "other", "dtype", "non_blocking", "copy", "memory_format"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", device = "Device", options = "TensorOptions",
...
Tensor$set("public", "to_dense", function(dtype = NULL) {
  args <- mget(x = c("dtype"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "to_mkldnn", function(dtype = NULL) {
  args <- mget(x = c("dtype"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dtype = "ScalarType")
  nd_args <- "self"
...
Tensor$set("private", "_topk", function(k, dim = -1L, largest = TRUE, sorted = TRUE) {
  args <- mget(x = c("k", "dim", "largest", "sorted"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "triangular_solve", function(A, upper = TRUE, transpose = FALSE, unitriangular = FALSE) {
  args <- mget(x = c("A", "upper", "transpose", "unitriangular"))
  args <- append(list(self = self), args)
  expected_types <- list(
...
Tensor$set("public", "tril", function(diagonal = 0L) {
  args <- mget(x = c("diagonal"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", diagonal = "int64_t")
  nd_args <- "self"
...
Tensor$set("public", "tril_", function(diagonal = 0L) {
  args <- mget(x = c("diagonal"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", diagonal = "int64_t")
  nd_args <- "self"
...
Tensor$set("public", "triu", function(diagonal = 0L) {
  args <- mget(x = c("diagonal"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", diagonal = "int64_t")
  nd_args <- "self"
...
Tensor$set("public", "triu_", function(diagonal = 0L) {
  args <- mget(x = c("diagonal"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", diagonal = "int64_t")
  nd_args <- "self"
...
Tensor$set("public", "true_divide", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "true_divide_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "unbind", function(dim = 1L) {
  args <- mget(x = c("dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", dim = c("int64_t", "Dimname"))
  nd_args <- c("self", "dim")
...
Tensor$set("public", "unflatten", function(dim, sizes, names = NULL) {
  args <- mget(x = c("dim", "sizes", "names"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("int64_t", "Dimname"), sizes = "IntArrayRef",
    names = "DimnameList"
  )
...
Tensor$set("public", "unfold", function(dimension, size, step) {
  args <- mget(x = c("dimension", "size", "step"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dimension = "int64_t", size = "int64_t",
    step = "int64_t"
  )
...
Tensor$set("public", "uniform_", function(from = 0L, to = 1L, generator = NULL) {
  args <- mget(x = c("from", "to", "generator"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "unsafe_chunk", function(chunks, dim = 1L) {
  args <- mget(x = c("chunks", "dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", chunks = "int64_t", dim = "int64_t")
  nd_args <- c("self", "chunks")
...
Tensor$set("public", "unsafe_split", function(split_size, dim = 1L) {
  args <- mget(x = c("split_size", "dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", split_size = "int64_t", dim = "int64_t")
  nd_args <- c("self", "split_size")
...
Tensor$set("public", "unsafe_split_with_sizes", function(split_sizes, dim = 1L) {
  args <- mget(x = c("split_sizes", "dim"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", split_sizes = "IntArrayRef", dim = "int64_t")
  nd_args <- c("self", "split_sizes")
...
Tensor$set("public", "var", function(dim, correction, unbiased = TRUE, keepdim = FALSE) {
  args <- mget(x = c("dim", "correction", "unbiased", "keepdim"))
  args <- append(list(self = self), args)
  expected_types <- list(
    self = "Tensor", dim = c("IntArrayRef", "DimnameList"),
...
Tensor$set("public", "vdot", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = "Tensor")
  nd_args <- c("self", "other")
...
Tensor$set("private", "_view", function(dtype, size) {
  args <- mget(x = c("dtype", "size"))
  args <- append(list(self = self), args)
...
Tensor$set("public", "vsplit", function(indices, sections) {
  args <- mget(x = c("indices", "sections"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", indices = "IntArrayRef", sections = "int64_t")
  nd_args <- c("self", "indices", "sections")
...
Tensor$set("public", "xlogy", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
...
Tensor$set("public", "xlogy_", function(other) {
  args <- mget(x = c("other"))
  args <- append(list(self = self), args)
  expected_types <- list(self = "Tensor", other = c("Tensor", "Scalar"))
  nd_args <- c("self", "other")
