...
cpp_Tensor_storage <- function(self) {
    cpp_handle_error(.Call('_torch_cpp_Tensor_storage', PACKAGE = 'torchpkg', self))
}

cpp_Tensor_has_storage <- function(self) {
    cpp_handle_error(.Call('_torch_cpp_Tensor_has_storage', PACKAGE = 'torchpkg', self))
}
...
cpp_tensor_is_contiguous <- function(self) {
    cpp_handle_error(.Call('_torch_cpp_tensor_is_contiguous', PACKAGE = 'torchpkg', self))
}
